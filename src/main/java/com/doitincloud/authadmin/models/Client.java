...
import com.doitincloud.authadmin.supports.Newable;
import com.doitincloud.authadmin.supports.ValidPassword;
import com.doitincloud.authadmin.supports.ValidPhoneNumber;
import com.doitincloud.authadmin.supports.ValidTermSet;
...
public class Client implements Newable {
    ...
    @Id
    @GenericGenerator(name = "client_id", strategy = "com.doitincloud.authadmin.supports.IdGenerator")
